...
<logic:notEmpty name="prodMgr" property="upSellProducts">
	<bean:define id="prodArray" name="prodMgr" property="upSellProducts"/>
	<div class="tile">
		<div class="up-sell-body">
			<!--- box border -->
			...
			<div class="tile-header">
				<bean:message key="up.sell.body.title"/>		
			</div>
