...
<html:form action="/ChangeDeliveryAddrSubmit.do" styleId="form1">  
	<div class="body">
		<div class="body-header">
			<img style="float:right" src="<%=kkEng.getImageBase()%>/table_background_delivery.gif" border="0" alt="<bean:message key="change.delivery.address.body.deliveryinformation"/>" title=" <bean:message key="change.delivery.address.body.deliveryinformation"/> " width="<%=kkEng.getHeadingImageWidth()%>" height="<%=kkEng.getHeadingImageHeight()%>">
			<bean:message key="change.delivery.address.body.deliveryinformation"/>
		 </div>
		<div class="body-content-div">
			<b><bean:message key="change.delivery.address.body.shippingaddress"/></b>
			<div class="msg-box">
				<table border="0" width="100%" cellspacing="0" cellpadding="2" class="body-content-tab">
					<tr>
						...
						<td  width="50%" valign="top"><bean:message key="change.delivery.address.body.shippinginfo"/>.</td>
						<td align="right" width="50%" valign="top">        
							<table border="0" cellspacing="0" cellpadding="2" class="body-content-tab">
								<tr>
									<td  align="center" valign="top"><b><bean:message key="change.delivery.address.body.shippingaddress"/>:</b><br><img src="<%=kkEng.getImageBase()%>/arrow_south_east.gif" border="0" alt="" width="50" height="31"></td>
									<td><img src="<%=kkEng.getImageBase()%>/pixel_trans.gif" border="0" alt="" width="10" height="1"></td>
			...
			</br><b><bean:message key="change.delivery.address.body.addrbookentries"/></b>
			<div class="msg-box">
				<table border="0" width="100%" cellspacing="0" cellpadding="2" class="body-content-tab">
					<tr>
						<td><img src="<%=kkEng.getImageBase()%>/pixel_trans.gif" border="0" alt="" width="10" height="1"></td>
						<td  width="50%" valign="top"><bean:message key="change.delivery.address.body.selectaddr"/>.</td>
						<td  width="50%" valign="top" align="right"><b><bean:message key="change.delivery.address.body.pleaseselect"/></b><br><img src="<%=kkEng.getImageBase()%>/arrow_east_south.gif" border="0" alt="" width="40" height="32"></td>
						<td><img src="<%=kkEng.getImageBase()%>/pixel_trans.gif" border="0" alt="" width="10" height="1"></td>
					</tr>
					<%
									com.konakart.forms.ChangeAddrForm myForm = (com.konakart.forms.ChangeAddrForm) request.getAttribute("ChangeAddrForm"); 					
									myForm.setAddrId(new Integer(order.getDeliveryAddrId()).toString());
					%>
	...
	<div class="tile">
			<div class="button-left"><div class="button-right"><div class="button-bottom"><div class="button-bottom-left"><div class="button-bottom-right"><div class="button-top"><div class="button-top-left"><div class="button-top-right">
				<div class="button-tile">
					...
					<bean:message key="change.delivery.address.body.continuecheckout"/>.									
				</div>
