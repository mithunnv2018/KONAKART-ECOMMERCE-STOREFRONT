...
<div class="body">
	...
	<div class="body-content-div">
		...
		<h4>Duly Noted Ltd.</h4>
		 <b>Executive Director :</b> Angela . K. Watsam LLB, LLM
		 <br/>	
		 <b>Email ID :</b> : angela@dulynoted.co.uk
		 <hr/>

		 <b>Canada Country Director :</b> Oleg Kroitor
		 <br/>	
		 <b>Email ID :</b> info@dulynoted.co.uk
		 <hr/>
		 
		 <b>UK Country Project Manager :</b> Cordelia Akanmu 
		 <br/>	
		 <b>Email ID :</b> cordelia@dulnoted.co.uk
		 <hr/>		 
		 <b>US Country Director :</b> Oleh Hereliuk 
		 <br/>	
		 <b>Email ID :</b> oleh@dulnoted.co.uk
		 <hr/>			 
		 <b>IT Manager :</b> Atul Kulve 
		 <br/>	
		 <hr/>	
	</div>
</div>
