...
<logic:notEmpty name="prodMgr" property="alsoPurchased">
	<bean:define id="prodArray" name="prodMgr" property="alsoPurchased"/>
	<div class="tile">
		<div class="also-purchased-body">
			<!--- box border -->
			...
			<div class="tile-header">
				<bean:message key="also.purchased.body.title"/>		
			</div>
