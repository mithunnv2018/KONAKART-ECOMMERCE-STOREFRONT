...
<logic:notEmpty name="prodMgr" property="crossSellProducts">
	<bean:define id="prodArray" name="prodMgr" property="crossSellProducts"/>
	<div class="tile">
		<div class="cross-sell-body">
			...
			<div class="tile-header">
				<bean:message key="cross.sell.body.title"/>		
			</div>
