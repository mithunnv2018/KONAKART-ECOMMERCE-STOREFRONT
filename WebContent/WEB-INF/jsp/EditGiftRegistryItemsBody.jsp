...
<html:form action="/EditWishListSubmit.do" styleId="form1">  
	...
	<div class="body">
		<div class="body-header">
			<img style="float:right" src="<%=kkEng.getImageBase()%>/table_background_cart.gif" border="0" alt="<bean:message key="edit.gift.registry.item.body.whats.in"/>" title=" <bean:message key="edit.gift.registry.item.body.whats.in"/> " width="<%=kkEng.getHeadingImageWidth()%>" height="<%=kkEng.getHeadingImageHeight()%>">
			<bean:message key="common.edit"/>&nbsp;<%=myForm.getListName()%>
		 </div>
		<div class="body-content-div">
			<logic:empty  property="itemList" name="EditWishListForm">
				<div class="msg-box"><bean:message key="edit.gift.registry.item.body.empty"/></div>
			</logic:empty>
			<logic:notEmpty property="itemList" name="EditWishListForm">
				<table border="0" width="100%" cellspacing="0" cellpadding="2" class="productListing">
					...
					<%}%>
							...
							<td align="center" class="productListing-data" valign="top">
								<nested:text size="5" property="quantityDesired"/>
							</td>
							<td align="center" class="productListing-data" valign="top">
	...
	<div class="tile">
		<div class="button-left"><div class="button-right"><div class="button-bottom"><div class="button-bottom-left"><div class="button-bottom-right"><div class="button-top"><div class="button-top-left"><div class="button-top-right">
			<div class="button-tile">
				...
				<a onclick="javascript:document.forms['form1'].submit();" class="button"><span><bean:message key="edit.gift.registry.item.body.update"/></span></a>
			</div>
