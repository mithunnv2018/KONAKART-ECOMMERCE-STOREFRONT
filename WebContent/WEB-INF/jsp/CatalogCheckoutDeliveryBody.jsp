...
//--></script>
<html:form action="/CheckoutDeliverySubmit.do" styleId="form1">  
	<html:hidden name="CheckoutForm" property="payment" value="dummy"/>
	<%
		...
		if (myForm != null){
			...
			if (orderMgr.getShippingQuotes() != null && orderMgr.getShippingQuotes().length > 0) myForm.setShipping(orderMgr.getShippingQuotes()[0].getCode());
			if (order.getShippingQuote() != null) myForm.setShipping(order.getShippingQuote().getCode());
			if (order.getStatusTrail() != null && order.getStatusTrail()[0] != null) myForm.setComment(order.getStatusTrail()[0].getComments());
		}				
	%>
	<div class="body">
		<div class="body-header">
			<img style="float:right" src="<%=kkEng.getImageBase()%>/table_background_delivery.gif" border="0" alt="<bean:message key="checkout.delivery.deliveryinformation"/>" title=" <bean:message key="checkout.delivery.deliveryinformation"/> " width="<%=kkEng.getHeadingImageWidth()%>" height="<%=kkEng.getHeadingImageHeight()%>">
			<bean:message key="checkout.delivery.deliveryinformation"/>
		 </div>
		<div class="body-content-div">
			<b><bean:message key="checkout.delivery.shippingaddress"/></b>
			<div class="msg-box">
				<table border="0" width="100%" cellspacing="0" cellpadding="2" class="body-content-tab">
					<tr>
						...
						<td  width="50%" valign="top"><bean:message key="checkout.delivery.deliveryinstructions"/>.<br><br>
							<html:link page="/ChangeDeliveryAddr.do">
						...
						<td align="right" width="50%" valign="top">
							<table border="0" cellspacing="0" cellpadding="2" class="body-content-tab">
								<tr>
									<td  align="center" valign="top"><b><bean:message key="checkout.delivery.shippingaddress"/>:</b><br><img src="<%=kkEng.getImageBase()%>/arrow_south_east.gif" border="0" alt="" width="50" height="31"></td>
									<td><img src="<%=kkEng.getImageBase()%>/pixel_trans.gif" border="0" alt="" width="10" height="1"></td> 
									<td  valign="top"><%=kkEng.removeCData(order.getDeliveryFormattedAddress())%></td>
									<td><img src="<%=kkEng.getImageBase()%>/pixel_trans.gif" border="0" alt="" width="10" height="1"></td> 
								</tr>
							</table>
						</td>
			...
			<br/><b><bean:message key="checkout.delivery.shippingmethod"/></b>
			<div class="msg-box">	
				<table border="0" width="100%" cellspacing="0" cellpadding="2" class="body-content-tab">
					<tr>
						<td><img src="<%=kkEng.getImageBase()%>/pixel_trans.gif" border="0" alt="" width="10" height="1"></td>
						<td  width="50%" valign="top"><bean:message key="checkout.delivery.selectshippingmethod"/>.</td>
						<td  width="50%" valign="top" align="right"><b><bean:message key="checkout.delivery.pleaseselect"/></b><br><img src="<%=kkEng.getImageBase()%>/arrow_east_south.gif" border="0" alt="" width="40" height="32"></td>
						<td><img src="<%=kkEng.getImageBase()%>/pixel_trans.gif" border="0" alt="" width="10" height="1"></td>
					</tr>
									...
									<td colspan="2">
										<table border="0" width="100%" cellspacing="0" cellpadding="2" class="body-content-tab">
											<tr>
												...
												<td  colspan="3"><b><%=quote.getTitle()%></b>&nbsp;</td>
												<td width="10"><img src="<%=kkEng.getImageBase()%>/pixel_trans.gif" border="0" alt="" width="10" height="1"></td>
											</tr>
											<tr class="moduleRow" onmouseover="rowOverEffect(this)" onmouseout="rowOutEffect(this)">
												<td width="10"><img src="<%=kkEng.getImageBase()%>/pixel_trans.gif" border="0" alt="" width="10" height="1"></td>
												<td  width="75%"><%=quote.getResponseText()%> <%=kkEng.formatPrice(quote.getFreeShippingOver())%></td>
												<td width="10"><img src="<%=kkEng.getImageBase()%>/pixel_trans.gif" border="0" alt="" width="10" height="1"></td>
											</tr>
										</table>
									</td>
								...
								<tr>
									...
									<td colspan="2">
										<table border="0" width="100%" cellspacing="0" cellpadding="2" class="body-content-tab">
											...
											<tr class="moduleRow" onmouseover="rowOverEffect(this)" onmouseout="rowOutEffect(this)">
												<td width="10"><img src="<%=kkEng.getImageBase()%>/pixel_trans.gif" border="0" alt="" width="10" height="1"></td>
												<td  width="75%"><%=quote.getResponseText()%></td>
												<%if (kkEng.displayPriceWithTax()) {%>
													<td ><%=kkEng.formatPrice(quote.getTotalIncTax())%></td>
												<%} else {%>
													<td ><%=kkEng.formatPrice(quote.getTotalExTax())%></td>
												<%}%>	
												<td  align="right"><html:radio name="CheckoutForm" property="shipping" value="<%=quote.getCode()%>"/></td>
												<td width="10"><img src="<%=kkEng.getImageBase()%>/pixel_trans.gif" border="0" alt="" width="10" height="1"></td>
											</tr>
										</table>
									</td>
			...
			<%String dispPointsEntry = kkEng.getConfig("ENABLE_REWARD_POINTS");if (dispPointsEntry!=null && dispPointsEntry.equalsIgnoreCase("TRUE")) { %>				
				...
				<% } %>
			<% } %>
			<br/><b><bean:message key="checkout.delivery.addcomments"/></b>
			<div class="msg-box-no-pad">
				<table border="0" width="100%" cellspacing="0" cellpadding="2" class="body-content-tab">
					<tr>
	...
	<div class="tile">
			<div class="button-left"><div class="button-right"><div class="button-bottom"><div class="button-bottom-left"><div class="button-bottom-right"><div class="button-top"><div class="button-top-left"><div class="button-top-right">
				<div class="button-tile">							
					...
					<bean:message  key="checkout.delivery.continuecheckout"/>.
				</div>
	...
	<table border="0" width="100%" cellspacing="0" cellpadding="0">
		...
		<tr>
			<td align="center" width="25%" class="checkoutBarCurrent"><bean:message key="checkout.common.deliveryinformation"/></td>
			<td align="center" width="25%" class="checkoutBarTo"><bean:message key="checkout.common.paymentinformation"/></td>
